...
var TemplatePreviewModalModule = (function () {
    function TemplatePreviewModalModule() {
    }
    TemplatePreviewModalModule = __decorate([
        NgModule({
            imports: [
                CommonModule,
    ...
    return TemplatePreviewModalModule;
}());
export { TemplatePreviewModalModule };
