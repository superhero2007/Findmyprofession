...
var WorkExperienceItemModule = (function () {
    function WorkExperienceItemModule() {
    }
    WorkExperienceItemModule = __decorate([
        NgModule({
            imports: [
                CommonModule,
                FormsModule,
    ...
    return WorkExperienceItemModule;
}());
export { WorkExperienceItemModule };
