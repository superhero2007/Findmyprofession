...
var CareerFinderCongratulationModule = (function () {
    function CareerFinderCongratulationModule() {
    }
    CareerFinderCongratulationModule = __decorate([
        NgModule({
            imports: [
    ...
    ], CareerFinderCongratulationModule);
    return CareerFinderCongratulationModule;
}());
export { CareerFinderCongratulationModule };
