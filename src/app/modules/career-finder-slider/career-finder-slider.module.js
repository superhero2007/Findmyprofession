...
var CareerFinderSliderModule = (function () {
    function CareerFinderSliderModule() {
    }
    CareerFinderSliderModule = __decorate([
        NgModule({
            imports: [
                CommonModule,
                CustomRangeModule,
    ...
    return CareerFinderSliderModule;
}());
export { CareerFinderSliderModule };
