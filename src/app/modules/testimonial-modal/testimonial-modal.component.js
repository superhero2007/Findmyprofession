...
var TestimonialModalComponent = (function () {
    function TestimonialModalComponent(activeModal) {
    ...
    TestimonialModalComponent.prototype.close = function () {
        this.activeModal.close('Close');
    };
    TestimonialModalComponent = __decorate([
        Component({
...
export { TestimonialModalComponent };
